...
\begin{problemset}
	...
	\end{enumerate}
	\item Considerando o universo dos números naturais dado os subconjuntos:  $A = \{1, 2, 3, 4, 5\}$, $B = \{x \in \Nat \mid x^2 = 9\}$, $C = \{x \in \Nat \mid x^2 - 4x + 6 = 0\}$ e $D = \{x \in \Nat \mid  x = 2k \mbox{ para algum } k \in \Nat\}$, complemente as frase com os símbolos $\subseteq, \not\subseteq$.
	\begin{enumerate}
		\item $A \ \underline{ \ \ \ \ \ \ } \ B$.
		\item $C \ \underline{ \ \ \ \ \ \ } \ B$.
		\item $D \ \underline{ \ \ \ \ \ \ } \ C$.
